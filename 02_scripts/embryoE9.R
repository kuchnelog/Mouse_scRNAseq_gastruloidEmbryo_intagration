...
em.sing.markers_1 <- FindAllMarkers(em.sing, group.by = "RNA_snn_res.1", only.pos = TRUE, min.pct = 0.25, logfc.threshold = 0.25)
...
em.sing.markers_3 <- FindAllMarkers(em.sing, group.by = "RNA_snn_res.3", only.pos = TRUE, min.pct = 0.25, logfc.threshold = 0.25)
...
## Plots -----------------------------------------------------------------------
Idents(em.sing) <- em.sing@meta.data$RNA_snn_res.1
