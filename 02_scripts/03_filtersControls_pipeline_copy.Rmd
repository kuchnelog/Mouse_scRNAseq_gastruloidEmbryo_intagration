...
metadata <- read.table(paste0(PATH_ROOT, "/03_qc/metadata_", DATASET, "_filtered.csv"), header = TRUE, sep = ",")
umapCoord <- read.table(paste0(PATH_ROOT, "/04_process/DR_umap_", DATASET, "_filtered.csv"), header = TRUE, sep = ",")
```

# Filtered cells repartition {.tabset .tabset-pills .tabset-fade}

```{r importClustering, out.width="50%"}
knitr::include_graphics(paste0(PATH_OUT_FIG, "/02_process_dimplot-cluster-fltd-1.png"))
```
